...
public class IOSLauncher extends IOSApplication.Delegate//UIApplicationDelegateAdapter
{
    ...
    protected IOSApplication createApplication() {
        ...
        return new IOSApplication(new MyTemplateGame(), config);
    }
    ...
    public void didFinishLaunching (UIApplication application) {
        ...
        boton.addOnTouchUpInsideListener(new UIControl.OnTouchUpInsideListener() {
            @Override
        ...
        boton2.addOnTouchUpInsideListener(new UIControl.OnTouchUpInsideListener() {
            @Override
            public void onTouchUpInside (UIControl control, UIEvent event) {
        ...
        boton3.addOnTouchUpInsideListener(new UIControl.OnTouchUpInsideListener() {
            @Override
            public void onTouchUpInside (UIControl control, UIEvent event) {
        ...
        boton4.addOnTouchUpInsideListener(new UIControl.OnTouchUpInsideListener() {
            @Override
            public void onTouchUpInside (UIControl control, UIEvent event) {
        ...
        boton5.addOnTouchUpInsideListener(new UIControl.OnTouchUpInsideListener() {
            @Override
            public void onTouchUpInside (UIControl control, UIEvent event) {
                gcManager.reportScore("1212", 3);
            }
        });
        ...
        boton6.addOnTouchUpInsideListener(new UIControl.OnTouchUpInsideListener() {
            @Override
            public void onTouchUpInside (UIControl control, UIEvent event) {
        ...
        boton7.addOnTouchUpInsideListener(new UIControl.OnTouchUpInsideListener() {
            @Override
            public void onTouchUpInside (UIControl control, UIEvent event) {
        ...
        boton8.addOnTouchUpInsideListener(new UIControl.OnTouchUpInsideListener() {
            @Override
            public void onTouchUpInside (UIControl control, UIEvent event) {
